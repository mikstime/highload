...
ученика, месты работы учителя, и так далее.
...
хранилище типа ключ-значение (в крайнем случае колоночную базу данных) 
в силу большей производительности по сравнению с документоориентированными базами. 
При необходимости изменения данных, приложение будет считывать старую версию, 
вносить изменение и перезаписывать значение.
